        ...
        <el-col :span="24">
          <div class="div1" >
              ...
              <el-row>
                ...
                <el-col :span="3"><h2 class="font-bold title-font"></h2><span class="title-span"> 模拟发电效率 </span></el-col>
                
                <el-col :span="1"><img src="../../assets/images/stationdetail/protocolpr.png"></el-col>
                <el-col :span="3"><h2 class="font-bold title-font"></h2><span class="title-span"> 协议效能比 </span></el-col>
        ...
        <el-col :span="12">
          <div class="div4-left">
            ...
            <el-row>
              ...
              <el-col :span="6"><h2 class="font-bold title-font"></h2><span class="title-span"> 合同时间 </span></el-col>
            </el-row>
            <el-row>
              <el-col :span="2"><img src="../../assets/images/stationdetail/avgratio.png"></el-col>
              <el-col :span="6"><h2 class="font-bold title-font">1<span>Wh/㎡</span></h2><span class="title-span"> 年均辐照量 </span></el-col>
              <el-col :span="2"><img src="../../assets/images/stationdetail/contactpower.png"></el-col>
              <el-col :span="6"><h2 class="font-bold title-font">2<span>kWh</span></h2><span class="title-span"> 合同发电量 </span></el-col>
            </el-row>
          </div>
        </el-col>
        <el-col :span="12">
      ...
      getDetail() {
        getStationDetail().then((data) => {
          if (data.successful) {
            ...
            if(data.resultValue.photoPath){
              this.detail.photoPath = (process.env.NODE_ENV === "development" ? "/api" : process.env.VUE_APP_BASE_API) + "/minio/preViewPicture/"+ data.resultValue.photoPath;
