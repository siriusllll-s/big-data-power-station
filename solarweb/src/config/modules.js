...
export const modules = [
  ...
  },
  {
    ...
    group: "数据",
    component: "DataMonitoring/Threshold",
    routerFile: "dataMonitoring.js",
    status: "ready",
    owner: "前端-C / 后端-A",
    desc: "报警阈值配置",
    apis: [
      { method: "POST", url: "/api/threshold/pageByParam", desc: "阈值分页" },
      { method: "POST", url: "/api/threshold/save", desc: "阈值保存" }
    ]
  },
  {
    id: 51,
    ...
    group: "数据",
    component: "DataMonitoring/HistoryData",
    routerFile: "dataMonitoring.js",
    status: "ready",
    owner: "前端-C",
    desc: "设备历史发电量",
    apis: [{ method: "POST", url: "/api/monitor/historyData", desc: "历史数据" }]
  },
  {
    id: 52,
    name: "电站发电量",
    ...
    icon: "el-icon-s-data",
    group: "数据",
    component: "DataMonitoring/StationPower",
    routerFile: "dataMonitoring.js",
    status: "ready",
    owner: "前端-C",
    desc: "电站天发电量",
    apis: [{ method: "POST", url: "/api/monitor/stationPower", desc: "电站发电量" }]
  },
  {
    id: 53,
    name: "逆变器监控",
    ...
    group: "数据",
    component: "DataMonitoring/Inverter",
    routerFile: "dataMonitoring.js",
    status: "ready",
    owner: "前端-C",
    desc: "逆变器实时",
    apis: [{ method: "GET", url: "/api/monitor/inverter", desc: "逆变器" }]
  },
  {
    id: 54,
    name: "汇流箱监控",
    ...
    icon: "el-icon-menu",
    group: "数据",
    component: "DataMonitoring/CombinerBox",
    routerFile: "dataMonitoring.js",
    status: "ready",
    owner: "前端-C",
    desc: "汇流箱实时",
    apis: [{ method: "GET", url: "/api/monitor/combinerBox", desc: "汇流箱" }]
  },
  {
    id: 55,
    name: "电表监控",
    ...
    group: "数据",
    component: "DataMonitoring/Meter",
    routerFile: "dataMonitoring.js",
    status: "ready",
    owner: "前端-C",
    desc: "电表实时",
    apis: [{ method: "GET", url: "/api/monitor/meter", desc: "电表" }]
  },
  {
    id: 6,
    name: "数据分析",
